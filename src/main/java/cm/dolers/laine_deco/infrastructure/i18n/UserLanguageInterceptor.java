...
/**
 * Intercepteur pour appliquer automatiquement la langue préférée de l'utilisateur
 * Priorité:
...
public class UserLanguageInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        // 3. Accept-Language header est géré automatiquement par Spring (AcceptHeaderLocaleResolver)
