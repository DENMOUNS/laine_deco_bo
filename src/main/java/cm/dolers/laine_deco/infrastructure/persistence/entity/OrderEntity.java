...
public class OrderEntity {
    ...
    @OneToMany(mappedBy = "order", orphanRemoval = true, fetch = jakarta.persistence.FetchType.EAGER)
    ...
    private String couponType;             // ALL_PRODUCTS, SINGLE_PRODUCT, FREE_SHIPPING, FIXED_AMOUNT
    ...
    // Coupon and Discount getters/setters
    ...
    // Loyalty Points getters/setters
