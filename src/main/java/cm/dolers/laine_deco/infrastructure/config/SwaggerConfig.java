    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
            ...
            .info(new Info()
                ...
                .version("1.0.0")
                .description("""
                    Documentation complète de l'API Laine Déco - Plateforme de vente de laine et accessoires
                    
                    ## Authentification
                    Utilisez un token Bearer dans l'en-tête `Authorization: Bearer <token>`
                    """)
                .contact(new Contact()
        ...
        // Pas de security globale pour que les routes publiques soient accessibles sans token dans Swagger
    }
}