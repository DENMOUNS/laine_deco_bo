...
public class PublicProductFilterController {
        private static final org.slf4j.Logger log = org.slf4j.LoggerFactory
                        .getLogger(PublicProductFilterController.class);
         ...
         * @param sortBy      Critère de tri (PRICE_ASC, PRICE_DESC, RATING, NEWEST,
         *                    POPULARITY)
        ...
        public ResponseEntity<Page<ProductResponse>> filterProducts(
                ...
                log.info(
                                "GET /api/public/products/filter - Filtering products: keyword={}, categoryId={}, brand={}, page={}, pageSize={}",
